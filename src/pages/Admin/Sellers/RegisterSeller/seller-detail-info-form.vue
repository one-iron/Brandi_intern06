...
<!--      </a-descriptions-item>-->
      <a-descriptions-item :span="3">
        ...
        <div v-for="(item, i) in dataStore.detailData.manager_information">
          <hr v-if="i > 0">
          <div class="manager">
...
<!--      </a-descriptions-item>-->
      <a-descriptions-item :span="3" label="샐러상태 변경이력">
        ...
        <table class="bordered">
          ...
          <tbody>
          <tr v-for="item in dataStore.detailData.status_histories">
...
export default {
  ...
  methods: {
    ...
    popManager() {
      if (this.dataStore.detailData.manager_information.length > 1)
        this.dataStore.detailData.manager_information.pop()
    },
