  ...
  <div>
    <a-input-group>
      ...
      <a-row :gutter="8" class="filter-row">
        ...
        <a-col :span="22">
          <multi-select-buttons :multiple-select="false" :items="constants.sellerSections" v-model="filter.seller_property_id"/>
        </a-col>
      </a-row>
      <a-row :gutter="8" class="filter-row">
...
export default {
  ...
  methods: {
    ...
    getFilter() {
      ...
      if (!filter['brand_name_korean'])
        delete filter['brand_name_korean']
